...
public class GUI extends JFrame
{
	...
	public GUI()
	{
		...
		table_OrderBook.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		...
		label_InfoVolume.setFont(new Font("맑은 고딕", Font.PLAIN, 10));
		...
		label_InfoHighPrice.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		label_InfoLowPrice.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		label_InfoChangeRate.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		label_InfoChangePrice.setFont(new Font("맑은 고딕", Font.BOLD, 12));
		...
		label_InfoName.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		label_InfoSymbol.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		...
		label_InfoTradePrice.setFont(new Font("맑은 고딕", Font.BOLD, 18));
		...
		tabbedPane_CoinList.addTab("KRW", null, panel_KRW, "원화 마켓");
		...
		table_KRW.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "이름", "현재가", "전일대비", "거래량" }) 
		{
			Class[] columnTypes = new Class[] 
			{
				String.class, String.class, String.class, String.class
		...
		tabbedPane_CoinList.addTab("BTC", null, panel_BTC, "BTC 마켓");
		...
		table_BTC.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "이름", "현재가", "전일대비", "거래량" }) 
		{
			Class[] columnTypes = new Class[] 
			{
				String.class, String.class, String.class, String.class
		...
		table_BTC.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		...
		tabbedPane_CoinList.addTab("ETH", null, panel_ETH, "ETH 마켓");
		...
		table_ETH.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "이름", "현재가", "전일대비", "거래량" }) 
		{
			Class[] columnTypes = new Class[] 
			{
				String.class, String.class, String.class, String.class
		...
		table_ETH.setFont(new Font("맑은 고딕", Font.PLAIN, 12));
		...
		tabbedPane_CoinList.addTab("보유코인", null, panel_MyCoin, "나의 보유 코인");
